"""Tool: weather via Open-Meteo. Recycled from nebu, stripped LiveKit."""
...
def get_weather(city: str) -> str:
    """Get current weather for a city. Uses Open-Meteo (no API key)."""
    try:
        # Geocode
        ...
        cur = weather["current"]
        desc = _WMO.get(cur["weather_code"], "condiciones variables")
        return (
